...
def main():
    ...
    print('N:', N)
    '''
    Nprof=65537
    ...
    while g!=1:
        mas=2**16
        e=random.randint(2,mas+1)
        g,x,y=egcd(e,eprof)
    print(e)
    m = encodeText(s, keylen)
    c=pow(m[0],eprof,Nprof)
    mMod=pow(c,1/eprof)
    print(mMod)
    c2=pow(mMod,e)
    print(c)
